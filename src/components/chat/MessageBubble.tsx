...
export function MessageBubble({
  ...
  const bubbleBase = cn(
    "relative inline-block max-w-[78%] sm:max-w-[70%] px-3.5 py-2 text-sm break-words whitespace-pre-wrap leading-snug",
    "transition-shadow",
    isMine
  ...
  return (
    ...
    >
      ...
      <motion.div
        className={cn("flex flex-col", isMine ? "items-end" : "items-start", "min-w-0")}
        animate={{ x: dragX }}
